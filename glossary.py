# glossary.py — Somali Financial Glossary for Hagarlaawe News Bot
...
GLOSSARY = {
    ...
    # GEOPOLITICS & WAR (NEW)
    # ---------------------------------------------------------
    "sanctions": "cunaqabatayn",
    "ceasefire": "joojinta dagaalka",
    "peace talks": "wadahadalka nabadda",
    "trade war": "dagaalka ganacsiga",
    "tariff": "cashuur-gal",
    "tariffs": "cashuuraha gal-ka",
    "embargo": "xidhid ganacsi",
    "missile strike": "weerarka gantaalo",
    "airstrike": "duqeyn",
    "military escalation": "kordhin militari",
    "diplomatic relations": "xiriirka diblomaasiyeed",
    "summit": "shir madaxeedka",
    "treaty": "heshiis caalami",
    "alliance": "isbahaysi",
